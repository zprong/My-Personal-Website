...
const Navbar = () => {
  return (
    <nav className="sticky top-0 left-0 right-0 p-4 gap-10 flex justify-start items-center bg-white dark:bg-neutral-900 border-b border-neutral-200 dark:border-neutral-800">
